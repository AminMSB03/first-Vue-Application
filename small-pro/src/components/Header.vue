...
<div class="container-fluid w-full flex flex-wrap items-center justify-between px-6">
    ...
    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bars" class="w-6" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <path fill="currentColor" d="M16 132h416c8.837 0 16-7.163 16-16V76c0-8.837-7.163-16-16-16H16C7.163 60 0 67.163 0 76v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.1 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837 163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16z"></path>
    </svg>
    </button>
    <div
    ...
    <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
        ...
        <router-link to="/" class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" >Dashboard</router-link>
        </li>
        <li class="nav-item p-2">
        <a
